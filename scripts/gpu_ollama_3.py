        ...
        try:
            ...
            with suppress_stdout_stderr():
                h_agent.initiate_chat(
                    ...
                    max_turns=8,  # Reduced for speed
                    silent=True  # This should help suppress output
                )
...
def main():
    ...
    parser.add_argument("--models", nargs='+', default=["empathy05_1", "empathy05_2"], 
                        help="Model names")
    ...
    results = process_parallel(df, gpu_manager, args.n_workers)
