...
def main():
    ...
    parser.add_argument("--planning_method", choices=['cot', 'react', 'None'], default='cot', help="Planning method to use")
    ...
    # df = df.head(100)  # For testing, limit to 100 rows
    print('Loaded dataframes successfully')

    print('Running Bullying Simulation with', args.input_csv)
    ...
    output_csv_path = os.path.join(output_dir, f"jailbreak_{llm_config['config_list'][0]['model']}_{current_date}_{os.path.basename(args.input_csv)}_{args.planning_method}.csv")
